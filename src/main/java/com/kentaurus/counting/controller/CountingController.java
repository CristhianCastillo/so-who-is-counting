    ...
    public Table readFile(String path, String fileName, int numberEnter, int numberEnd, int countNumber)
        ...
        try {
            ...
            if (!isFileLinesValid(path, linesExpect))
                throw new Exception(PropertiesCache.MESSAGE_ERROR_INVALID_FILE);
            ...
            while ((this.line = bufferReader.readLine()) != null) {
                ...
                if ((valuesSplit.length - 1) != countNumber)
                    throw new Exception(String.format(PropertiesCache.MESSAGE_ERROR_INVALID_ROW, countRow));
                ...
                try {
                    ...
                    throw new Exception(String.format(PropertiesCache.MESSAGE_ERROR_INVALID_NUMBER, countRow));
                }
                ...
                for (int i = 1; i < valuesSplit.length; i++) {
                    ...
                    try {
                        ...
                        throw new Exception(String.format(PropertiesCache.TITLE_APPLICATION, i, countRow));
                    }
